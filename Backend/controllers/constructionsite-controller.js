...
const getSiteBySiteObjectId = async (req, res) => {
  try {
    const id = req.params.id;

    // Find the site by mongoDB Id
...
export { addConstructionSite, updateSiterBySiteId, deleteConstructionSite, getSiteBySiteId, getAllSites, getSitesByManagerId, getSiteCountsByProvince, getSiteBySiteObjectId };