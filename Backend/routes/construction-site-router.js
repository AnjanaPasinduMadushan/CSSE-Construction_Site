...
import { addConstructionSite, updateSiterBySiteId, deleteConstructionSite, getSiteBySiteId, getAllSites, getSitesByManagerId, getSiteCountsByProvince, getSiteBySiteObjectId } from '../controllers/constructionsite-controller.js';
...
constructionsite_router.get("/sitebyObjectId/:id", getSiteBySiteObjectId);
