  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <Divider />
        <List>
          {['Create Accounts', 'Add Sites', 'Requisitions', 'invoices', 'Requesting Approvals', 'Delivery Details'].map((text, index) => (
        ...
        <Divider />
        <List>
          {['Suppliers', 'SiteManagers', 'Accountants'].map((text, index) => (
            <ListItem key={text} disablePadding sx={{ display: 'block' }}>
              <ListItemButton
                sx={{
                  minHeight: 48,
          ...
          <ListItem disablePadding sx={{ display: 'block', marginTop: 20 }}>
            <ListItemButton
              sx={{
                minHeight: 48,
                justifyContent: open ? 'initial' : 'center',
